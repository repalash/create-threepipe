...
// prettier-ignore
const helpMessage = `\
Usage: create-threepipe [OPTION]... [DIRECTORY]

Create a new Threepipe project in JavaScript or TypeScript.
...
const FRAMEWORKS: Framework[] = [
  ...
  //   variants: [
  //     {
  //       name: 'create-threepipe-extra',
  //       display: 'create-threepipe-extra ↗',
  //       color: reset,
...
const defaultTargetDir = 'threepipe-project'
